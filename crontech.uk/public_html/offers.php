...
<style>
    ...
    h1, h2, h3, h4, h5, .hero-title, .purchase-title { color:#111827 !important; }
    .hero-desc, .purchase-desc { color:#4b5563 !important; }
    .purchase-section { background:#fff7e0 !important; }
    .moonlight-section, .screenshot-section { background:#f4f7f9 !important; }
    .purchase-btn, .moonlight-btn { background:#ffb703 !important; color:#111 !important; border-radius:8px !important; }
    .purchase-btn:hover, .moonlight-btn:hover { background:#fb8500 !important; }
