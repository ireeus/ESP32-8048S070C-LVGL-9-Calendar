...
<style>
    ...
    .purchase-btn, .btn-primary, button[type="submit"] { background:#ffb703 !important; color:#111 !important; border-radius:8px !important; }
    .purchase-btn:hover, .btn-primary:hover { background:#fb8500 !important; }
