...
// The colour scheme and brightness picked on settings.php -> Themes belong to the
// Cron-Tab DEVICE, not to this page. The calendar used to read user_theme and
// restyle itself from it; that is deliberately gone, so the site keeps the fixed
// look it had before and only the device changes.
