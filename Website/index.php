...
<head>
    ...
    <!-- Meta Title optimized for target keywords & brand -->
    <title>CronTech Electrical | Certified EICR & PAT Testing Services UK</title>
    <!-- Meta Description under 160 characters with strong call to action -->
    <meta name="description" content="Professional, fully compliant EICR and PAT testing services for domestic and commercial properties. Transparent pricing and rapid 24h certification by NAPIT & NICEIC engineers.">
    <link rel="canonical" href="https://www.crontechelectrical.co.uk/">
    
    <!-- Open Graph / Social Media Meta Tags -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="CronTech Electrical | Certified EICR & PAT Testing Services UK">
    <meta property="og:description" content="Fast, reliable electrical safety checks and certifications across the UK. Get an instant quote today.">
    
    <!-- Schema.org Structured Data for Local SEO & Rich Snippets -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Electrician",
      "name": "CronTech Electrical Services",
      "description": "Certified EICR and PAT testing services for domestic and commercial properties in the UK.",
      "priceRange": "££",
      "areaServed": "UK",
      "aggregateRating": {
...
<script
src="https://www.paypal.com/sdk/js?client-id=Ad3T1XJoOoH8i19EhqZg5PoX89pckJiAovAEJ3hqbXTnvMLzlwOJfRe1PpX52bjlx2zJiR466GVwPtMI&currency=GBP&components=messages"
data-namespace="PayPalSDK">
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Montserrat', sans-serif; }
        ...
        .video-container .overlay { position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255, 255, 255, 0.60); backdrop-filter: blur(5px); }
        ...
        .discount-banner {
            ...
            font-size: 14px; border-bottom: 1px solid #fca5a5; display: none; z-index: 19; position: relative;
            margin-top: 5px; 
        }
        ...
        .client-toolbar { display: flex; flex-wrap: wrap; gap: 15px; justify-content: space-between; align-items: center; margin-bottom: 20px; }
        .client-tabs { display: flex; gap: 8px; flex-wrap: wrap; }
        .client-tab-btn { background: #fff; border: 1px solid var(--border-light); padding: 8px 16px; border-radius: 6px; cursor: pointer; font-weight: 700; font-size: 12px; color: var(--text-muted); transition: 0.2s; }
        .client-tab-btn:hover { background: #f3f4f6; }
        .client-tab-btn.active { background: var(--text-main); color: #fff; border-color: var(--text-main); }
        .client-search-input { padding: 10px 14px; border: 1px solid var(--border-light); border-radius: 6px; font-size: 13px; font-weight: 500; outline: none; width: 100%; max-width: 250px; }
        .client-search-input:focus { border-color: var(--primary); box-shadow: 0 0 0 3px rgba(255, 183, 3, 0.15); }
        ...
        .br-col { display: flex; align-items: center; gap: 8px; font-size: 13px; }
        
        .br-date { font-weight: 700; color: var(--text-main); white-space: nowrap; width: 90px; }
        .br-address { color: var(--text-muted); font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; flex: 1; min-width: 150px; }
        .br-details { font-weight: 700; color: var(--text-main); white-space: nowrap; }
        ...
        .br-pdf-btn { 
            background: #fffbeb; color: var(--primary-hover); border-radius: 4px; padding: 6px 12px; 
            text-decoration: none; font-weight: 800; font-size: 11px; display: flex; align-items: center; 
            gap: 5px; transition: 0.2s; white-space: nowrap; border: 1px solid #fde68a; cursor: pointer;
            text-transform: uppercase;
        }
        .br-pdf-btn:hover { background: #fde68a; color: #b45309; }
        
        .br-pdf-btn.btn-hide:hover { background: #fca5a5 !important; color: #991b1b !important; }
        .br-pdf-btn.btn-resume:hover { background: #bfdbfe !important; color: #1d4ed8 !important; }

        @media(max-width: 850px) {
            .booking-row-item { flex-wrap: wrap; gap: 10px; }
            .br-date { width: auto; }
            .br-address { width: 100%; white-space: normal; }
            .client-search-input { max-width: 100%; }
        }

        .pat-section { background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 15px; margin-top: 20px; }
        .service-type-group { margin-bottom: 20px; }
        .service-option { display: flex; align-items: center; padding: 10px; background: #f9fafb; border: 1px solid var(--border-light); border-radius: 8px; margin-bottom: 8px; cursor: pointer; transition: all 0.2s; }
        .service-option:hover { border-color: #cbd5e1; background: #f3f4f6; }
        .service-option input[type="radio"] { appearance: none; -webkit-appearance: none; width: 18px; height: 18px; border: 1px solid #cbd5e1; border-radius: 50%; margin: 0 10px 0 0; cursor: pointer; position: relative; }
        .service-option input[type="radio"]:checked { border-color: var(--primary); background-color: var(--primary); }
        .service-option input[type="radio"]:checked::after { content: ''; position: absolute; top: 4px; left: 4px; width: 8px; height: 8px; background: #fff; border-radius: 50%; }
        .service-option span { font-size: 13px; font-weight: 600; color: var(--text-main); }
        ...
        .modal-content {
            ...
            border-radius: 16px; padding: 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.2);
            max-height: 90vh; display: flex; flex-direction: column;
        }
        .tc-text {
            overflow-y: auto; flex: 1; border: 1px solid #e5e7eb;
            padding: 20px; margin: 15px 0; border-radius: 8px; font-size: 13px; color: #4b5563;
            background: #f9fafb; line-height: 1.6;
        }
        .tc-text h4 { color: #1f2937; margin-top: 0; font-size: 14px; margin-bottom: 8px;}
        .tc-text p { margin-top: 0; margin-bottom: 15px; }
        .tc-text p:last-child { margin-bottom: 0; }
    </style>
</head>
<body>
...
<section class="hero-section">
    ...
    <div class="hero-container">
        <div class="hero-text">
            ...
            <!-- Added primary H1 heading for clear keyword targeting -->
            <h1>Fast & Reliable <span>EICR & PAT</span> Certificates UK</h1>
            ...
            <div class="benefits-list">
                <div class="benefit-item"><div class="benefit-icon">✓</div>Fully Qualified Engineers</div>
            ...
            <div class="card" id="main-card">
                ...
                <form id="booking-form" onsubmit="return false;">
                    <div class="step active" id="step-2">
                        ...
                        <p class="subtitle">Select the type of electrical safety inspection you need.</p>
                        
                        <div class="service-type-group">
                            <label class="service-option" onclick="selectService('eicr')">
                                <input type="radio" name="service_type" value="eicr" checked onchange="updateStep2Visibility()">
                                <span>EICR Only – Fixed wiring safety check</span>
                            </label>
                            <label class="service-option" onclick="selectService('pat')">
                                <input type="radio" name="service_type" value="pat" onchange="updateStep2Visibility()">
                                <span>PAT Only – Appliance testing</span>
                            </label>
                            <label class="service-option" onclick="selectService('both')">
                                <input type="radio" name="service_type" value="both" onchange="updateStep2Visibility()">
                                <span>Both EICR & PAT – Complete safety</span>
                            </label>
                        </div>

                        <div id="eicr_fields" style="display:block;">
                        ...
                        <div id="pat_section" style="display:none;" class="pat-section">
                            <div id="pat_items_group" style="display: block;">
                                <label class="form-label" for="pat_items" style="color: #065f46;">Number of Appliances to Test</label>
                                <input type="number" id="pat_items" name="pat_items" value="15" min="1" style="border-color: #86efac;">
                                <p style="font-size: 11px; color: #166534; margin-top: 5px; margin-bottom: 0;">Ensure all plug-in appliances are safe.</p>
                            </div>
                        </div>
                    ...
                    <div class="step" id="step-3">
                        ...
                        <p class="subtitle">Where is the inspection taking place?</p>
                        <div class="form-group">
                    ...
                    <div class="step" id="step-5">
                        ...
                        <button type="button" id="btn-open-tc" class="btn btn-primary" style="margin-top: 15px; margin-bottom: 15px; background: #3b82f6; color: #ffffff;" onclick="document.getElementById('tc-modal').style.display='flex'">📝 Read Terms & Conditions to Proceed</button>
                    ...
                    <div class="step" id="step-my-bookings">
                        ...
                        <div class="client-toolbar">
                            <div class="client-tabs" id="client-tabs">
                                <button type="button" class="client-tab-btn active" id="tab-requested" onclick="filterClientBookings('requested')">Requested / Active</button>
                                <button type="button" class="client-tab-btn" id="tab-paid" onclick="filterClientBookings('paid')">Paid</button>
                                <button type="button" class="client-tab-btn" id="tab-quotes" onclick="filterClientBookings('quotes')">Quotes</button>
                                <button type="button" class="client-tab-btn" id="tab-rejected" onclick="filterClientBookings('rejected')">Rejected</button>
                                <button type="button" class="client-tab-btn" id="tab-all" onclick="filterClientBookings('all')">All</button>
                            </div>
                            <input type="text" id="client-search" class="client-search-input" placeholder="🔍 Search any field..." onkeyup="filterClientBookings()">
                        </div>

                        <div id="bookings-list" style="max-height: 400px; overflow-y: auto; padding-right: 5px; margin-bottom: 15px;"></div>
...
<section class="content-section bg-light">
    <!-- Updated section titles to structured semantic H2 and H3 headings -->
...
<section class="content-section" style="background:#fff;">
    <h2>Why Choose CronTech Electrical?</h2>
    <div class="grid-2">
        <article class="text-block" style="border:none; box-shadow:none;">
            <h3>Certified & Reliable Electricians</h3>
            <p>Our engineers are fully qualified, insured, and registered with leading UK electrical bodies (NAPIT / NICEIC) or verified by CTTA. We pride ourselves on punctuality and transparent, fixed pricing with no hidden costs.</p>
            
            <h3 style="margin-top:20px;">Fast 24-Hour Certificate Turnaround</h3>
        ...
        <article class="text-block" style="border:none; box-shadow:none;">
            ...
            <p>If your installation is found to be "Unsatisfactory", our report will detail exactly what remedial work is required (categorized as C1, C2, C3 or FI). We will provide a no-obligation quote to fix the issues, but you are free to use any registered electrician.</p>
        </article>
    </div>
</section>
</main>
...
<div id="tc-modal" class="modal-overlay" style="display: none;">
    <div class="modal-content">
        <h2 style="margin-top:0; color:#1f2937;">Terms & Conditions</h2>
        <div class="tc-text">
            <h4>1. Access and Safety</h4>
            <p>The engineer must have clear and safe access to the consumer unit (fusebox) and all electrical accessories. The power will be safely isolated (turned off) for a significant portion of the test. Please ensure critical equipment (servers, medical devices, aquariums) are safely powered down prior to our arrival.</p>
            <h4>2. EICR Outcomes</h4>
            <p>An EICR is an inspection, not a repair service. If the installation is found to be "Unsatisfactory" (C1, C2, C3 or FI codes), a quote for remedial repairs will be provided by a third-party contractor. The only exception is if the required repairs fall under the category of a <strong>Minor Electrical Installation Works Certificate</strong> (e.g., replacing a broken socket or light fitting, replacing a faulty switch, or adding a single socket to an existing circuit), which we may quote for directly. You are under no obligation to use the recommended third-party for any repairs.</p>
            <h4>3. Deposit & Cancellations</h4>
            <p>The 10% deposit secures your booking date. Cancellations made less than 48 hours before the scheduled appointment may result in forfeiture of the deposit.</p>
            <h4>4. Data Processing (UK GDPR)</h4>
            <p>We will store and process your personal details strictly for the purpose of completing this service and issuing the relevant safety certificates. We do not sell your data to third parties.</p>
        </div>
        <label class="custom-checkbox" style="margin-bottom: 15px; border-color:#3b82f6; background:#eff6ff;">
            <input type="checkbox" id="modal-terms-checkbox" onchange="handleTCAccept()">
            <span style="color:#1e3a8a; font-weight:700;">I have read and agree to these Terms & Conditions and consent to data processing (UK GDPR).</span>
        </label>
        <button type="button" class="btn btn-back" style="margin-top:0;" onclick="document.getElementById('tc-modal').style.display='none'">Close</button>
    </div>
</div>

<div id="cookie-alert" class="cookie-alert">
    <div class="cookie-content">
        <p>We use cookies and local storage to improve your experience and securely process your bookings. By continuing to use our site, you accept our privacy policy.</p>
        <button class="btn btn-primary btn-cookie" onclick="acceptCookies()">Accept & Close</button>
    </div>
</div>
...
<script>
    ...
    let currentClientTab = 'requested';
    ...
    document.addEventListener("DOMContentLoaded", async () => {
		...
		if (!localStorage.getItem('crontech_cookie_consent')) {
			document.getElementById('cookie-alert').style.display = 'flex';
		}
        
        try {
            const res = await fetch('api_eicr.php?action=get_config');
    ...
    function updateStep2Visibility() {
        ...
        const eicrFields = document.getElementById('eicr_fields');
        const patSection = document.getElementById('pat_section');

        if (serviceType === 'pat') {
            eicrFields.style.display = 'none';
            patSection.style.display = 'block';
        } else if (serviceType === 'eicr') {
            eicrFields.style.display = 'block';
    ...
    function togglePatInput() {
        ...
        const serviceType = document.querySelector('input[name="service_type"]:checked').value;
        if (serviceType === 'pat') {
            document.getElementById('pat_included').checked = true;
            document.getElementById('pat_items_group').style.display = 'block';
            return;
        }
        if (serviceType === 'eicr') {
            document.getElementById('pat_included').checked = false;
            document.getElementById('pat_items_group').style.display = 'none';
            return;
        }
    ...
    function resetToHome() {
        ...
        if (topBtn) {
            topBtn.style.display = (myBookings.length > 0 || myQuotes.length > 0) ? 'inline-block' : 'none';
            topBtn.innerHTML = 'My Bookings';
            topBtn.onclick = showMyBookings;
        }
    ...
    async function showMyBookings() {
        ...
        if(myBookings.length === 0 && myQuotes.length === 0) return;
        
        try {
            clientBookingsData = [];
            
            if (myBookings.length > 0) {
                const res = await fetch('api_eicr.php?action=get_my_bookings', {
                    method: 'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({bookings: myBookings})
                });
                const data = await res.json();
                if(data.success) {
                    clientBookingsData = data.data; 
                }
            }
            
            document.getElementById('wizard-scroll-target').style.maxWidth = '900px';
            document.querySelectorAll('.step').forEach(el => el.classList.remove('active'));
            ...
            let topBtn = document.getElementById('btn-my-bookings');
            if (topBtn) {
                topBtn.innerHTML = 'Get a quote';
                topBtn.onclick = resetToHome;
            }
            
            scrollToWizard();
            
            filterClientBookings(currentClientTab);
        } catch(e) { console.error(e); }
    }

    function filterClientBookings(tab = null) {
        if (tab) currentClientTab = tab;
        
        let quotes = JSON.parse(localStorage.getItem('crontech_quotes') || '[]').filter(q => !q.hidden);
        
        let combinedData = [];
        clientBookingsData.forEach(b => combinedData.push({...b, type: 'booking'}));
        quotes.forEach(q => combinedData.push({
            id: q.id,
            date: q.date,
            address: q.address,
            prop_type: 'Quote: ' + q.prop_type,
            total: q.total,
            status: 'Unpaid Quote',
            type: 'quote',
            quoteKey: q.quoteKey
        ...
        let counts = { requested: 0, paid: 0, rejected: 0, quotes: 0, all: combinedData.length };
        combinedData.forEach(b => {
            if (b.type === 'quote') {
                counts.quotes++;
            } else {
                let s = (b.status || '').toLowerCase();
                if (s.includes('pending') || s.includes('accepted') || s.includes('awaiting')) counts.requested++;
                else if (s.includes('paid')) counts.paid++;
                else if (s.includes('rejected')) counts.rejected++;
            }
        });

        document.getElementById('tab-requested').style.display = counts.requested > 0 ? 'inline-block' : 'none';
        document.getElementById('tab-paid').style.display = counts.paid > 0 ? 'inline-block' : 'none';
        document.getElementById('tab-rejected').style.display = counts.rejected > 0 ? 'inline-block' : 'none';
        document.getElementById('tab-quotes').style.display = counts.quotes > 0 ? 'inline-block' : 'none';
        document.getElementById('tab-all').style.display = counts.all > 0 ? 'inline-block' : 'none';

        if (counts[currentClientTab] === 0 && counts.all > 0) {
            if (counts.requested > 0) currentClientTab = 'requested';
            else if (counts.quotes > 0) currentClientTab = 'quotes';
            else if (counts.paid > 0) currentClientTab = 'paid';
            else if (counts.rejected > 0) currentClientTab = 'rejected';
            else currentClientTab = 'all';
        }

        document.querySelectorAll('.client-tab-btn').forEach(b => b.classList.remove('active'));
        let activeBtn = document.getElementById('tab-' + currentClientTab);
        if (activeBtn) activeBtn.classList.add('active');

        if (counts.all === 0) {
            document.getElementById('btn-my-bookings').style.display = 'none';
            document.getElementById('bookings-list').innerHTML = '<p style="text-align:center; padding: 20px; color:var(--text-muted);">No bookings or quotes found.</p>';
            resetToHome();
            return;
        }
        ...
        let filtered = combinedData.filter(b => {
            let searchableText = [b.id, b.date, b.address, b.prop_type, b.total, b.status].join(' ').toLowerCase();
            let matchesSearch = query === '' || searchableText.includes(query);
            
            let matchesTab = true;
            if (currentClientTab !== 'all') {
                if (currentClientTab === 'quotes') matchesTab = b.type === 'quote';
                else if (currentClientTab === 'requested') matchesTab = b.type === 'booking' && (b.status.toLowerCase().includes('pending') || b.status.toLowerCase().includes('accepted') || b.status.toLowerCase().includes('awaiting'));
                else if (currentClientTab === 'paid') matchesTab = b.type === 'booking' && b.status.toLowerCase().includes('paid');
                else if (currentClientTab === 'rejected') matchesTab = b.type === 'booking' && b.status.toLowerCase().includes('rejected');
            }
            return matchesSearch && matchesTab;
        });

        if(filtered.length === 0) {
            list.innerHTML = '<p style="text-align:center; padding: 20px; color:var(--text-muted);">No items match your search.</p>';
        } else {
            filtered.forEach(b => {
                let statusColor = '#fb8500'; 
                let statusIcon = '⏳';
                let isRejected = false;
                let isQuote = b.type === 'quote';
                
                if (isQuote) {
                    statusColor = '#8b5cf6';
                    statusIcon = '📝';
                } else if(b.status.includes('Accepted')) {
                    statusColor = '#2563eb';
                    statusIcon = '🗓️';
                ...
                if(statusColor === '#ef4444' || statusColor === '#9ca3af') badgeBgSafe = '#f3f4f6';
                if(statusColor === '#2563eb') badgeBgSafe = '#eff6ff';
                if(statusColor === '#089c22') badgeBgSafe = '#f0fdf4';
                if(isQuote) badgeBgSafe = '#f3e8ff';
                ...
                if (isRejected) {
                    actionHtml += `
                        <button type="button" class="br-pdf-btn btn-hide" style="background:#fef2f2; color:#ef4444; border-color:#fca5a5; margin-left: 8px;" onclick="deleteUserBooking('${b.id}')">
                            🗑
                        </button>
                    `;
                }
                ...
                if (isQuote) {
                    actionHtml += `
                        <button type="button" class="br-pdf-btn btn-resume" style="background:#eff6ff; color:#2563eb; border-color:#bfdbfe; margin-left: 8px;" onclick="resumeQuote('${b.quoteKey}')">
                            ▶️ Resume
                        </button>
                        <button type="button" class="br-pdf-btn btn-hide" style="background:#fef2f2; color:#ef4444; border-color:#fca5a5; margin-left: 8px;" onclick="hideQuote('${b.quoteKey}')">
                            🗑
                        </button>
                    `;
                }
                ...
                list.innerHTML += `
                    <div class="booking-row-item">
                        <div class="br-col br-date">🗓️ ${b.date}</div>
                        <div class="br-col br-address">📍 ${b.address}</div>
                        <div class="br-col br-details">⚡ ${b.prop_type} - £${b.total}</div>
                        <div class="br-col br-status" style="color:${statusColor}; background:${badgeBgSafe}; border: 1px solid ${statusColor};">
                            ${statusIcon} ${statusText}
                        </div>
                        <div class="br-col br-action">
                            ${actionHtml}
                        </div>
                    </div>
                `;
    ...
    function deleteUserBooking(id) {
        if (!confirm("Are you sure you want to hide this booking from your history?")) return;
        
        let myBookings = JSON.parse(localStorage.getItem('crontech_bookings') || '[]');
        myBookings = myBookings.filter(b => b.id !== id);
        localStorage.setItem('crontech_bookings', JSON.stringify(myBookings));
        
        clientBookingsData = clientBookingsData.filter(b => b.id !== id);
    ...
    function hideQuote(quoteKey) {
        if (!confirm("Are you sure you want to hide this quote?")) return;
        let quotes = JSON.parse(localStorage.getItem('crontech_quotes') || '[]');
        let q = quotes.find(x => x.quoteKey === quoteKey);
        if(q) q.hidden = true;
        localStorage.setItem('crontech_quotes', JSON.stringify(quotes));
        
        showMyBookings();
    }

    function resumeQuote(quoteKey) {
        let quotes = JSON.parse(localStorage.getItem('crontech_quotes') || '[]');
        let q = quotes.find(x => x.quoteKey === quoteKey);
        if (!q) return;

        if(q.service_type_val) {
            let rb = document.querySelector('input[name="service_type"][value="' + q.service_type_val + '"]');
            if(rb) rb.checked = true;
        }
        if(q.prop_type_val) document.getElementById('prop_type').value = q.prop_type_val;
        if(q.circuits) document.getElementById('circuits').value = q.circuits;
        if(q.pat_items) document.getElementById('pat_items').value = q.pat_items;
        document.getElementById('address').value = q.address || '';
        document.getElementById('booking_date').value = q.date || '';
        if(q.client_name) document.getElementById('client_name').value = q.client_name;
        if(q.client_email) document.getElementById('client_email').value = q.client_email;
        if(q.client_phone) document.getElementById('client_phone').value = q.client_phone;

        updateStep2Visibility();
        renderCalendar(currYear, currMonth);
        startUrgencyTimer(q.quoteKey);
        calculateQuote();
        ...
        document.getElementById('btn-open-tc').style.display = 'flex';
    ...
    function validateStep(stepId) {
        ...
        const serviceType = document.querySelector('input[name="service_type"]:checked').value;
        let inputsToCheck = step.querySelectorAll('input:not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), select, textarea');
        if (serviceType === 'pat') {
            inputsToCheck = Array.from(inputsToCheck).filter(el => el.id !== 'prop_type' && el.id !== 'circuits');
        }
        let isValid = true;
    ...
    async function loadBookedDates() {
        try {
            const res = await fetch('api_eicr.php?action=get_dates');
    ...
    function proceedToPayment() {
        ...
        let quotes = JSON.parse(localStorage.getItem('crontech_quotes') || '[]');
        let existingIndex = quotes.findIndex(q => q.quoteKey === quoteKey);
        let serviceType = document.querySelector('input[name="service_type"]:checked').value;
        
        let quoteObj = {
            id: 'QUOTE_' + Math.floor(1000 + Math.random() * 9000),
            quoteKey: quoteKey,
            date: document.getElementById('booking_date').value,
            address: addr,
            prop_type: serviceType.toUpperCase(),
            total: currentTotal.toFixed(2),
            hidden: false,
            service_type_val: serviceType,
            prop_type_val: document.getElementById('prop_type').value,
        ...
        if(existingIndex >= 0) {
            quoteObj.id = quotes[existingIndex].id;
    ...
    function handleTCAccept() {
        const cb = document.getElementById('modal-terms-checkbox');
        if (cb.checked) {
            document.getElementById('tc-modal').style.display = 'none';
            document.getElementById('btn-open-tc').style.display = 'none';
            
            const ppContainer = document.getElementById('paypal-button-container');
            ppContainer.style.display = 'block';
            ppContainer.style.opacity = '1';
            ppContainer.style.pointerEvents = 'auto';
            ppContainer.style.position = 'relative';
    ...
    function calculateQuote() {
        ...
        if (serviceType === 'eicr' || serviceType === 'both') {
        ...
        if (serviceType === 'pat' || (serviceType === 'both' && document.getElementById('pat_items_group'))) {
    ...
    function initPayPal() {
        paypal.Buttons({
            ...
            onClick: function(data, actions) {
                ...
                const errEl = document.getElementById('checkbox-error');
                
                if (termsEl && gdprEl && (!termsEl.checked || !gdprEl.checked)) {
            ...
            onApprove: function(data, actions) {
                ...
                return actions.order.capture().then(function(details) {
                    const bookingData = {
                        ...
                        circuits: document.getElementById('circuits').value,
                        pat_included: document.querySelector('input[name="service_type"]:checked').value === 'pat' || document.querySelector('input[name="service_type"]:checked').value === 'both',
                        pat_items: document.getElementById('pat_items').value,
                    ...
                    fetch('api_eicr.php?action=create', {
	...
	function acceptCookies() {
        localStorage.setItem('crontech_cookie_consent', 'true');
