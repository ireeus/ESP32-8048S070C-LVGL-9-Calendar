...
<div class="header">
    <a href="index.php" style="color: #fff; text-decoration: none; position: absolute; left: 20px; top: 20px; font-size: 14px; font-weight: 600;">&larr; Back to CronTech</a>
...
<script>
    function searchMember() {
        ...
        fetch('api.php?action=verify_member&query=' + encodeURIComponent(query))
        .then(res => res.json())
        .then(data => {
