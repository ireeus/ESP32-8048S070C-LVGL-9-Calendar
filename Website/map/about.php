...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Montserrat', sans-serif; }
        ...
        /* CONTENT */
        .content-section { padding: 60px 20px; max-width: 1000px; margin: 0 auto; flex: 1; }
...
<header class="site-header">
    <div class="header-container">
        ...
        <div class="header-actions">
            <a href="index.php" class="btn-nav">Book Now</a>
            <a href="offers.php" class="btn-nav">Offers</a>
